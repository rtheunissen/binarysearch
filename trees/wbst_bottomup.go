...
func (tree *WBSTBottomUp) Split(i list.Position) (list.List, list.List) {
   ...
   return &WBSTBottomUp{WeightBalance: tree.WeightBalance, Tree: Tree{arena: tree.arena, root: l, size: i}},
          &WBSTBottomUp{WeightBalance: tree.WeightBalance, Tree: Tree{arena: tree.arena, root: r, size: tree.size - i}}
}
