...
#set x2label     "α"     offset 0,0 rotate by 0
#set y2label     "α"     offset -3,0 rotate by 0
...
plot "wb_topdown_polytope_many.csv" using 1:2 with points pt 5 ps 0.175 lc rgb "#000000" notitle, \
