...
func (tree AVLWeakTopDown) Split(i Position) (List, List) {
   ...
   return &AVLWeakTopDown{AVLWeakBottomUp{AVLBottomUp: AVLBottomUp{Tree: Tree{arena: tree.arena, root: l, size: i}}}},
          &AVLWeakTopDown{AVLWeakBottomUp{AVLBottomUp: AVLBottomUp{Tree: Tree{arena: tree.arena, root: r, size: tree.size - i}}}}
}
...
func (tree AVLWeakTopDown) deleteMax(p **Node, s Size) (max *Node) {
   g := p
   if (*p).r == nil {
